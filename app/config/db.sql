...
insert  into `page_html`(`id`,`title`,`slug`,`content`,`is_active`,`created_at`,`updated_at`) values (1,'Giới thiệu A','gioi-thieu','Giới thiệu công ty',1,'2015-09-16 15:33:03',NULL),(2,'Điều khoản sử dụng','dieu-khoan-su-dung','Nội dung điều khoản',1,'2015-09-16 15:35:53',NULL),(3,'Dịch vụ A','dich-vu','Nội dung dịch vụ',1,'2015-09-16 15:38:15','2015-09-16 15:39:24');
